CREATE DATABASE  IF NOT EXISTS `active_directory` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `active_directory`;
-- MySQL dump 10.13  Distrib 8.0.30, for Win64 (x86_64)
--
-- Host: localhost    Database: active_directory
-- ------------------------------------------------------
...
INSERT INTO `user_directory` VALUES ('one','eno',1),('two','owt',2),('zero','orez',0);
